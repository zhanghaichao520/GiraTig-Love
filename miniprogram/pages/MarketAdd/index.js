  ...
  async saveItem() {
    ...
    if (this.data.credit <= 0) {
      ...
      return
        ...
        await wx.cloud.callFunction({name: 'addNews', data: {desc:"上架了物品【"+this.data.title+"】, 仅需" + this.data.credit + "积分即可购买！"}}).then()
  ...
  sendSubscribeMessage(e) {
     ...
     wx.cloud.callFunction({
      ...
      data: {
          ...
          taskName: '新物品上架咯',
          desc: "上架了物品【"+this.data.title+"】",
          credit: this.data.credit + " 积分",
          openidA: getApp().globalData._openidA, 
          openidB: getApp().globalData._openidB, 
          userA: this.getApp().globalData.userA, 
